...
// I HAVE USED GOOGLE API(PAID API LINE 6) AND LEAFLET API(FREE API LINE 177)

// Using Google's Maps API for maps
...
//       try {
//         const response = await axios.get(`https://maps.googleapis.com/maps/api/geocode/json?address=${formData.city},${formData.state}&key=YOUR_GOOGLE_API_KEY`);
